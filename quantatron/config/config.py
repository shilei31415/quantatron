...
class CfgNode(_CfgNode):
    ...
    def merge_from_file(self, cfg_filename: str, allow_unsafe: bool = True) -> None:
        """
        Load content from the given configs file and merge it into self.

        Args:
            cfg_filename: configs filename
        ...
        ), "CfgNode.merge_from_file is only allowed on a configs object of latest version!"
    ...
    def dump(self, *args, **kwargs):
        """
        Returns:
            str: a yaml string representation of the configs
        """
